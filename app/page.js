  ...
  return (
    <>
      <div className="w-full flex flex-col items-center justify-center " >
        <div className="font-extrabold my-12 text-4xl text-center">
                ...
                <div className="p-1 ">
                  <Card className="">
                    <CardContent className="flex  flex-col items-center justify-center p-6 h-2/4">
                      <span className="text-3xl font-semibold block">{message.title}</span>
                      <span className="text-2xl font-medium block">Message from {message.sender}</span>
                    </CardContent>
                  </Card>
                </div>
              </CarouselItem>
