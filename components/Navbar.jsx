...
const page = () => {
    ...
    return (
        <>
            <nav className="flex justify-between md:justify-around items-center py-2  w-full mx-auto border-b-1 border-black">

                <Link href='/'>
                    <h1 className='font-bold text-2xl   '>QuickMessages</h1>
                </Link>
